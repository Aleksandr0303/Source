        ...
        switch (item.nodeName) {
          ...
          case 'INPUT':
            if (item.getAttribute('type') === 'checkbox') {
              i === 0 ? state[prop] = "Холоное" : state[prop] = "Теплое";
...
var checkNumInputs = function checkNumInputs(selector) {
  var numInput = document.querySelectorAll(selector);
...
var modals = function modals() {
  ...
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false); //showModalByTime('.popup', 600000);
};
